...
public class BattleService {
    ...
    public Battle scheduleBattle(Battle battle) {
        battle.setId(null);
        battle.setStatus(BattleStatus.SCHEDULED);
        return battleRepository.save(battle);
    }

    public BattleParticipant register(String battleId, String userId, String displayName) {
        Battle battle = getBattle(battleId);
        if (battle.getStatus() != BattleStatus.SCHEDULED && battle.getStatus() != BattleStatus.REGISTRATION) {
    ...
    public Battle endBattle(String battleId) {
        ...
        participants.forEach(p -> {
            ...
            // Notify participants
            notificationService.send(p.getUserId(), NotificationType.BATTLE,
    ...
    public List<Battle> getActiveBattles() {
        return battleRepository.findByStatusInOrderByScheduledAtDesc(
                List.of(BattleStatus.SCHEDULED, BattleStatus.REGISTRATION, BattleStatus.IN_PROGRESS));
    }
