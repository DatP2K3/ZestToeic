...
public class AIQuestionGenerator {
    ...
    public Map<String, Object> generate(int part, String difficulty, int count) {
        ...
        try {
            ...
            return Map.of("generated", 0, "saved", 0, "errors", List.of("Gemini API error: " + e.getMessage()));
        }

        List<Question> parsed = parseQuestions(rawResponse, part, difficulty);
        ...
        return Map.of(
                "generated", parsed.size(),
                "saved", saved,
                "duplicates", parsed.size() - saved - errors.size(),
                "errors", errors
        );
    }
