...
class BattleEventTest {
    ...
    void question() {
        ...
        assertEquals(BattleEventType.QUESTION, e.getType());
    ...
    void scoreUpdate() {
        ...
        assertEquals(BattleEventType.SCORE_UPDATE, e.getType());
    }

    @Test
    void started() {
        BattleEvent e = BattleEvent.started("b1");
        assertEquals(BattleEventType.BATTLE_STARTED, e.getType());
    ...
    void ended() {
        ...
        assertEquals(BattleEventType.BATTLE_ENDED, e.getType());
    }
    ...
    void playerJoined() {
        ...
        assertEquals(BattleEventType.PLAYER_JOINED, e.getType());
    }

    @Test
    void builderAndAccessors() {
        BattleEvent e = new BattleEvent();
        e.setType(BattleEventType.QUESTION);
        e.setBattleId("b");
        e.setPayload("p");
        assertEquals(BattleEventType.QUESTION, e.getType());
