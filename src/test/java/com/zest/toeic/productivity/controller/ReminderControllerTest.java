...
import com.zest.toeic.productivity.controller.ReminderController;
...
class ReminderControllerTest {
    ...
    void create() throws Exception {
        Reminder r = Reminder.builder().type(ReminderType.DAILY_STUDY).schedule("07:30").message("Learn!").build();
    ...
    void update() throws Exception {
        Reminder r = Reminder.builder().type(ReminderType.CUSTOM).schedule("08:00").message("Upd").build();
